-- Setup script for GrievanceAnalyticsDB
...
BEGIN
    -- Create the database with specific file locations
    CREATE DATABASE GrievanceAnalyticsDB
    ON PRIMARY (
        NAME = GrievanceAnalyticsDB,
        FILENAME = 'C:\Users\HP\Desktop\CDACProjectBackend\CollegeGrievance-Portal\GrivanveAnalyticDotNetMicroServiceCode\GrievanceAnalyticsService\GrievanceAnalyticsDB.mdf',
        SIZE = 10MB,
        MAXSIZE = UNLIMITED,
        FILEGROWTH = 5MB
    )
    LOG ON (
        NAME = GrievanceAnalyticsDB_Log,
        FILENAME = 'C:\Users\HP\Desktop\CDACProjectBackend\CollegeGrievance-Portal\GrivanveAnalyticDotNetMicroServiceCode\GrievanceAnalyticsService\GrievanceAnalyticsDB.ldf',
        SIZE = 5MB,
        MAXSIZE = UNLIMITED,
        FILEGROWTH = 5MB
    );
