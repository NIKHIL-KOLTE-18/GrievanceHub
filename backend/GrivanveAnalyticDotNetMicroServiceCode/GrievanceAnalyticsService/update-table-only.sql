-- Update script for GrievanceAnalyticsDB (Table structure only)
-- Use this if the database already exists but you need to update the table structure
...
PRINT 'Table structure update completed successfully!';
